...
USE_CAPTION_FILTER = is_enabled(environ.get('USE_CAPTION_FILTER', "False"), False)  # Use caption filter for search results (default: True)
...
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/scout_regimant")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/scout_regimant")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Tensura_movie') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Mikasa_devbot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Mikasa_Network') # Update channel link for the bot
