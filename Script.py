...
✨ ʜᴏᴡ ᴛᴏ ʀᴇǫᴜᴇꜱᴛ & ᴅᴏᴡɴʟᴏᴀᴅ ʙᴏᴏᴋꜱ ✨  

1️⃣ ꜱᴇᴀʀᴄʜ ᴛʜᴇ ʙᴏᴏᴋ ɴᴀᴍᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ ᴏʀ ʙᴏᴛ.  
...
3) ʙᴏᴏᴋ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ, ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs</b>"""
    ...
    MVE_NT_FND = NOT_FOUND_TXT = """<b>😌 ᴛʜɪꜱ ʙᴏᴏᴋ/ᴅᴏᴄᴜᴍᴇɴᴛ ɪꜱ ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ ʏᴇᴛ.
